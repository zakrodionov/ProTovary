...
abstract class BaseAdapter<T : Any>(data: List<T>) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: androidx.recyclerview.widget.RecyclerView.ViewHolder, position: Int) = delegatesManager.onBindViewHolder(data[position], position, holder)
