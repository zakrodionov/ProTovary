...
public class SupportXAppNavigator implements Navigator {
    ...
    public SupportXAppNavigator(FragmentActivity activity, int containerId) {
        this(activity, activity.getSupportFragmentManager(), containerId);
    }

    public SupportXAppNavigator(FragmentActivity activity, FragmentManager fragmentManager, int containerId) {
    ...
    protected void activityForward(Forward command) {
        SupportXAppScreen screen = (SupportXAppScreen) command.getScreen();
    ...
    protected void backTo(BackTo command) {
        if (command.getScreen() == null) {
            ...
            if (index != -1) {
                ...
                backToUnexisting((SupportXAppScreen) command.getScreen());
            }
        }
    }
    ...
    private void checkAndStartActivity(SupportXAppScreen screen, Intent activityIntent, Bundle options) {
     ...
     */
    protected void unexistingActivity(SupportXAppScreen screen, Intent activityIntent) {
     ...
     */
    protected Fragment createFragment(SupportXAppScreen screen) {
     ...
     * @param screen screen
     */
    protected void backToUnexisting(SupportXAppScreen screen) {
        backToRoot();
    }

    protected void errorWhileCreatingScreen(SupportXAppScreen screen) {
