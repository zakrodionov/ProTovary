...
@Inject constructor(private val productRepository: ProductRepository) : UseCase<LiveData<List<ProductInfo>>, GetProductsInfoUseCase.Params>() {

    override suspend fun run(params: Params): Either<Failure, LiveData<List<ProductInfo>>> = productRepository.getProductsInfo(params.id)
